...
def _call_llm_simple(messages, model=None, max_tokens=None, temperature=None, timeout=None):
    """Minimal OpenAI-compatible helper for context compression."""
    try:
    ...
    kwargs = {"model": model or "gpt-4o-mini", "messages": messages}
