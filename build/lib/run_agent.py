...
try:
    ...
    pass  # codex_responses_adapter removed in hermes-lite
...
class AIAgent:
    ...
    def _run_codex_stream(self, api_kwargs: dict, client: Any = None, on_first_delta: callable = None):
        ...
        try:
            ...
            pass  # codex_runtime removed in hermes-lite
    ...
    def _apply_client_headers_for_base_url(self, base_url: str) -> None:
        # hermes-lite — only Ollama, Anthropic, and OpenAI remain.
        # Removed providers (OpenRouter, Vercel AI Gateway, NVIDIA NIM, etc.)
        # do not need custom headers.
        _ph_headers = None
        try:
