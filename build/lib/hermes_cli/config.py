...
def _load_config_impl(*, want_deepcopy: bool) -> Dict[str, Any]:
    with _CONFIG_LOCK:
        # Lite profile short-circuit — bypass upstream DEFAULT_CONFIG merge
        if os.environ.get("HERMES_LITE_PROFILE"):
            from hermes_cli.lite_config import load_lite_config
            cfg = load_lite_config()
            return copy.deepcopy(cfg) if want_deepcopy else cfg
