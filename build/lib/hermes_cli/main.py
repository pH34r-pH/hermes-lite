...
def _apply_profile_override() -> None:
    ...
    # 1c. Special-case the lite profile — it is not a directory-based profile.
    if profile_name == "lite":
        os.environ["HERMES_LITE_PROFILE"] = "1"
...
def cmd_lite(args):
    """Lite command group dispatch."""
    from hermes_cli.lite_cmd import cmd_lite as _lite_dispatch
...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "kanban", "lite", "login", "logout", "logs", "lsp", "mcp", "memory", "migrate",
...
def main():
    ...
    # lite command
    # =========================================================================
    from hermes_cli.lite_cmd import add_lite_subparser

    add_lite_subparser(subparsers)
